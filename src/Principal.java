...
import com.alura.screenmatch.modelos.Pelicula.java;
...
public class Principal {
    ...
    public static void main(String[] args) {
        ...
        var peliculadejuanita = new Pelicula( nombre: "terminator destino oculto", 2019);
        peliculadejuanita.setDuracionEnMinutos(210);

        ArrayList<Pelicula> listadepeliculas = new ArrayList<>();
        listadepeliculas.add(peliculadejuanita);
